 ...
 *
 *  $Log: osif.c,v $
 *  Revision 1.134  2015/07/13 19:01:09  stefanm
 *  Changes to get the DPC kernel thread named like the loadable
 *  module is named (KBUILD_MODNAME).
 *  Some reordering, cleanup and additional comments.
 *
 ...
 */
 ...
 static char* rcsid = "$Id: osif.c,v 1.134 2015/07/13 19:01:09 stefanm Exp $";
#elif defined (__ghs__)                         /* Green Hills compiler */
# pragma ident "$Id: osif.c,v 1.134 2015/07/13 19:01:09 stefanm Exp $"
#elif ((__GNUC__ > 3) || (__GNUC__ == 3 && __GNUC_MINOR__ >=1)) /* GCC >= 3.1 */
 static char* rcsid __attribute__((unused,used)) = "$Id: osif.c,v 1.134 2015/07/13 19:01:09 stefanm Exp $";
#elif ((__GNUC__ > 2) || (__GNUC__ == 2 && __GNUC_MINOR__ >=7)) /* GCC >= 2.7 */
 static char* rcsid __attribute__((unused)) = "$Id: osif.c,v 1.134 2015/07/13 19:01:09 stefanm Exp $";
